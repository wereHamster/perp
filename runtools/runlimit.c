...
static const char prog_usage[] =
    ...
    " [-r rssbytes] [-s stackbytes] [-t cpusecs]" " program [args ...]";
...
static
void do_limit(int resource, const char *optc, const char *arg)
{
   struct rlimit  r;
   uint32_t       u;
...
int main(int argc, char *argv[], char *envp[])
{
   char           opt;
   nextopt_t      nopt =
       nextopt_INIT(argc, argv, ":hVva:c:d:f:l:m:o:p:r:s:t:");
